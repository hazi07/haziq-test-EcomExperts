...
if (productCards.length > 0) {
  // Loop throuhj all products
  productCards.forEach(card => {
    // Get variant for Color and add swatches
    ...
    // handle changing variant data based on the selected color swatch
    function changeVariantData(e) {
      // Remove the "active" class from color swatch 
      swatchElems.forEach(swatch => {
    ...
    function addToCart() {
      ...
      if (variant_id) {
        ...
        // Check if its black-medium variant with ID
        ...
        // add items in the cart By Post method
